...
public class PlanetDatabase {
    ...
    static {
        ...
        planets.add(new PlanetData(PlanetType.SUN, "Sun", "sun", "planets/sun1.png", 1500, false, -900, -20, 0.3f,
            27.9f, "Extrememe Heat", "Hydrogen/Helium", "Plasma", "Solar Energy"));

        // Sao Thủy (Region name: "mercury")
        planets.add(new PlanetData(PlanetType.MERCURY, "Mercury", "mercury", "planets/MercuryMapDemo.png", 150, true, -450, -240, 0.16f,
            3.70f, "Extreme Heat", "None", "Craters", "Rare Metals"));

        // Sao Kim (Region name: "venus")
        planets.add(new PlanetData(PlanetType.VENUS, "Venus", "venus", "planets/Venus.png", 230, true, -300, 50,0.15f,
            8.87f, "Extreme Heat", "CO2 (Toxic)", "Volcanic", "Sulfur"));

        // Trái Đất (Region name: "earth")
        planets.add(new PlanetData(PlanetType.EARTH, "Earth", "earth", "planets/earth1.png", 235, false, -150, -120,0.0f,
            9.81f, "Habitable", "Nitrogen/Oxygen", "Water/Land", "Organic Life"));

        // Mặt Trăng (Region name: "moon")
        planets.add(new PlanetData(PlanetType.MOON, "Moon", "moon", "planets/MoonMapDemo.png", 60, true, -40, -45,0.19f,
            1.62f, "Extreme Thermal Contrast", "None", "Dust", "Helium-3"));

        // Sao Hỏa (Region name: "mars")
        planets.add(new PlanetData(PlanetType.MARS, "Mars", "mars", "planets/MarsMapDemo.png",  160, true, 0, -280,0.19f,
            3.71f, "Cold", "CO2", "Red Dust", "Iron Oxide"));

        // Sao Mộc (Region name: "jupiter")
        planets.add(new PlanetData(PlanetType.JUPITER, "Jupiter", "jupiter", "planets/jupiter.png", 450, true, 220, 195,0.19f,
            24.79f, "Cold", "H2/He", "Gas Giant", "Hydrogen"));

        // Sao Thổ (Region name: "saturn")
        planets.add(new PlanetData(PlanetType.SATURN, "Saturn", "saturn", "planets/saturn.png", 450, true, 400, -300,0.19f,
            10.44f, "Cold", "H2/He", "Gas/Rings", "Ice Crystals"));

        // Sao Thiên Vương (Region name: "uranus")
        planets.add(new PlanetData(PlanetType.URANUS, "Uranus", "uranus", "planets/uranus.png", 380, true, 580, 75,0.19f,
            8.69f, "Frozen", "H2/He/Methane", "Ice Giant", "Water Ice"));

        // Sao Hải Vương (Region name: "neptune")
        planets.add(new PlanetData(PlanetType.NEPTUNE, "Neptune", "neptune", "planets/neptune.png", 350, true, 820, -200,0.21f,
